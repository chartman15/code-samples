...
get_histology_by_barcode <- function(barcode) {
  ...
  # Get unique histology composite values
  unique_histologies <- unique(matched$histology_composite)
  
  # Warn if multiple histologies found
...
# Add tumor and normal histology annotations to dbgap table
...
write_xlsx(dbgap_with_histology, "dbgap_with_histology.xlsx")
