...
Dot plot
```{r}
pdf(paste("Mel_Norm_2a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_primary_marker_DotPlot.pdf", sep=""),  width = 12, height = 20)
...
ncol <- floor(sqrt(n))
pdf(paste("Mel_Norm_2a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_Boxplot_primary_markers.pdf", sep=""), width = 20, height = 20)
...
pdf(paste("Mel_Norm_2a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_UMAP_primary_markers.pdf", sep=""),width=30,height=30)
...
pdf(paste("Mel_Norm_2a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_boxplots_with_avg_expression_of_cell_markers.pdf", sep=""),20,20)
do.call("grid.arrange", c(ggplot.list.2, ncol=nCol))
dev.off()
...
```{r}
 ...
 free_annotation <- c("melanocytes, fibroblasts", #0
                      "fibroblasts", #1
                      "T-cells, keratinocytes", #2
                      "fibroblasts", #3
                      "keratinocytes", #4
                      "mixed", #5
                      "melanocytes, fibroblasts", #6
                      "keratinocytes", #7
                      "vascular endothelial, keratinocytes", #8
                      "mixed", #9
                      "T cells", #10
                      "macrophages, DCs, monocytes", #11
                      "melanocytes", #12
                      "keratinocytes", #13
                      "vascular endothelial, keratinocytes", #14
                      "keratinocytes, sweat gland", #15
                      "vascular endothelial", #16
                      "melanocytes", #17
                      "sweat gland", #18
                      "melanocytes", #19
                      "melanocytes", #20
                      "melanocytes, keratinocytes", #21
...
save(seurat_phase, file='Mel_Norm_2a_Annotated_Cluster.RData')
...
seurat_phase <- RenameIdents(object = seurat_phase, 
                      ...
                      "1" = "fibroblasts", 
                      "2" = "T-cells, keratinocytes", 
                      "3" = "fibroblasts", 
                      "4" = "keratinocytes", 
                      "5" = "mixed", 
                      "6" = "melanocytes, fibroblasts", 
                      "7" = "keratinocytes", 
                      "8" = "vascular endothelial, keratinocytes", 
                      "9" = "mixed", 
                      "10" = "T cells", 
                      "11" = "macrophages, DCs, monocytes", 
                      "12" = "melanocytes", 
                      "13" = "keratinocytes", 
                      "14" = "vascular endothelial, keratinocytes", 
                      "15" = "keratinocytes, sweat gland", 
                      "16" = "vascular endothelial", 
                      "17" = "melanocytes", 
                      "18" = "sweat gland", 
                      "19" = "melanocytes", 
                      "20" = "melanocytes", 
                      "21" = "melanocytes, keratinocytes", 
...
# Plot the UMAP
pdf(paste("Mel_Norm_2a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_Annotated_UMAP.pdf", sep=""),20,20)
