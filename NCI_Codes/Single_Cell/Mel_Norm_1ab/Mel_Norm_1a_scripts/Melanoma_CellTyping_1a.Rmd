---
title: "Melanoma_CellTyping_1a"
output: html_document
date: "2024-02-06"
---

1a: Library Normalize or log Normalize, skip integration, clustering and cell typing on individual samples 
...
genes_to_check <- genes_to_check[genes_to_check %in% rownames(seurat_phase@assays$RNA)]
...
Dot plot
```{r}
pdf(paste("Mel_Norm_1a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_primary_marker_DotPlot.pdf", sep=""),  width = 12, height = 20)
...
genes_to_check <- cell.genes %>% filter(Type=="Primary")  %>% filter(gene%in%rownames(seurat_phase@assays$RNA))

seurat_phase <- JoinLayers(seurat_phase)

data_temp <- as.data.frame(as.matrix(GetAssayData(object=seurat_phase[["RNA"]], layer="data")))
...
ncol <- floor(sqrt(n))
pdf(paste("Mel_Norm_1a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_Boxplot_primary_markers.pdf", sep=""), width = 20, height = 20)
...
pdf(paste("Mel_Norm_1a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_UMAP_primary_markers.pdf", sep=""),width=30,height=30)
...

{
   ...
   clusters <- seurat_phase@meta.data$RNA_snn_res.0.9
...
pdf(paste("Mel_Norm_1a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_boxplots_with_avg_expression_of_cell_markers.pdf", sep=""),20,20)
...
free_annotation <- c("fibroblasts", #0
                     "melanocytes, fibroblasts", #1
                     "T cells", #2
                     "fibroblasts", #3
                     "vascular endothelial, keratinocytes", #4
                     "T cells, keratinocytes", #5
                     "keratinocytes", #6
                     "fibroblasts, schwann cells", #7
                     "mixed", #8
                     "melanocytes", #9
                     "melanocytes, fibroblasts", #10
                     "macrophages, DCs, monocytes", #11
                     "keratinocytes", #12
                     "keratinocytes", #13
                     "mixed", #14
                     "melanocytes, fibroblasts", #15
                     "sweat gland, keratinocytes", #16
                     "keratinocytes", #17
                     "vascular endothelial, lymphatic endothelial", #18
                     "melanocytes, fibroblasts", #19
                     "sweat gland", #20
...
save(seurat_phase, file='Mel_Norm_1a_Annotated_Cluster.RData')
...
seurat_phase <- RenameIdents(object = seurat_phase, 
                     "0" = "fibroblasts", 
                     "1" = "melanocytes, fibroblasts", 
                     "2" = "T cells", 
                     "3" = "fibroblasts", 
                     "4" = "vascular endothelial, keratinocytes", 
                     "5" = "T cells, keratinocytes", 
                     "6" = "keratinocytes", 
                     "7" = "fibroblasts, schwann cells", 
                     "8" = "mixed", 
                     "9" = "melanocytes", 
                     "10" = "melanocytes, fibroblasts", 
                     "11" = "macrophages, DCs, monocytes", 
                     "12" = "keratinocytes", 
                     "13" = "keratinocytes", 
                     "14" = "mixed", 
                     "15" = "melanocytes, fibroblasts", 
                     "16" = "sweat gland, keratinocytes", 
                     "17" = "keratinocytes", 
                     "18" = "vascular endothelial, lymphatic endothelial", 
                     "19" = "melanocytes, fibroblasts", 
                     "20" = "sweat gland", 
...
pdf(paste("Mel_Norm_1a_",n.pcs,"pcs_res",res.used,"_seed",seed.use,"_Annotated_UMAP.pdf", sep=""),20,20)
