...
#####################################################################################################################
  mutation_summary <- function(data,samples){
    ...
    tmp <- tmp %>%
      #mutate(n = as.numeric(n), Variant_Classification = fct_reorder(Variant_Classification,desc(as.numeric(n))))
      #mutate(Variant_Classification = reorder(Variant_Classification, -as.numeric(n)))
